        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartAddressId = table.Column<int>(type: "int", nullable: true),
                    EndAddressId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Addresses_EndAddressId",
                        column: x => x.EndAddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Orders_Addresses_StartAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeActivities_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleActivities_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeActivities_OrderId",
                table: "EmployeeActivities",
                column: "OrderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_EndAddressId",
                table: "Orders",
                column: "EndAddressId");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_StartAddressId",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleActivities_OrderId",
